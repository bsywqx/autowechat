...
# 从测试号信息获取
appID = "wx98b15a8f3bbfa76b"
appSecret = "2f0a06837ca0faa1ecf1cbacec0fa9c3"
#收信人ID即 用户列表中的微信号，见上文
openId = "o7iuV6tSedsnx9CGxEMQKaVdyh5s"
# 天气预报模板ID
weather_template_id = "5g4Xj3LZCsxXQwzQf95Bk_F4eSU723Nm72qRZb9n7Kc"
# 时间表模板ID
timetable_template_id = "fdSsYa4ze7Y1S00jA-fU_RCil5Adx9OxSLr3RCaG_68"
...
def send_timetable(access_token, message):
    ...
    print(timetable_template_id.strip())
    url = 'https://api.weixin.qq.com/cgi-bin/message/template/send?access_token={}'.format(access_token)
    print(requests.post(url, json.dumps(body)).text)
